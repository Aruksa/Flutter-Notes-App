...
import 'package:pilot/utilities/dialogs/password_reset_email_sent_dialog.dart';
    ...
    return BlocListener<AuthBloc, AuthState>(
        ...
        child: Scaffold(
          ...
          body: Padding(
              ...
              child: Column(
                  children: [
                    const Text('If you forgot your password, simply enter your email and we will send you a verification',),
                    TextField(
